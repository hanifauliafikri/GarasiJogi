...
/*=============== SWIPER MEMBER ===============*/
// let swiperMember = new Swiper(".member__container", {
//   loop: true,
//   spaceBetween: 24,
...
const sendEmail = (e) => {
  ...
  if (
    ...
    contactMessage.textContent = "mohon isi semua inputan 🙏";
  } else {
    emailjs
      .sendForm(
        "service_nik1cr4",
      ...
      .then(
        () => {
          ...
          contactMessage.textContent = "Pesan anda Terkirim 😃";
        ...
        (error) => {
          alert("Gawat! Something Has Failed...", error);
        }
      );
    contactName.value = "";
    contactEmail.value = "";
